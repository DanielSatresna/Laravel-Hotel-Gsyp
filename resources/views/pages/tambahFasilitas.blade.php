...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form class="card-body" method="POST" action="/tambahFasilitas">
                @csrf                

                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Fasilitas</label>
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control inputtags" name="namafasilitas">
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control inputtags" name="deskfasilitas">
                    </div>
                </div>
